...
namespace SantiagoConectaIA.API.EngramaLevels.Infrastructure.Repository
{
	...
	public class ConversationalRepository : IConversationalRepository
	{
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchTramitesForChat.Result, spSearchTramitesForChat.Request>(req, "","SCIA");
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchOficinasForChat.Result, spSearchOficinasForChat.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchRequisitosForChat.Result, spSearchRequisitosForChat.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchCostoForChat.Result, spSearchCostoForChat.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchOficinasByTramite.Result, spSearchOficinasByTramite.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
			// La capa de Infraestructura devuelve el mensaje de error del SP o del DapperManagerHelper
		...
		{
			var res = await _managerHelper.GetAllAsync<spGetChat.Result, spGetChat.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAsync<spSaveChat.Result, spSaveChat.Request>(req, "","SCIA");
		...
		{
			var res = await _managerHelper.GetAllAsync<spGetMensaje.Result, spGetMensaje.Request>(req, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAsync<spSaveMensaje.Result, spSaveMensaje.Request>(req, "","SCIA");
			if (res.Ok && res.Data != null) return res.Data;
