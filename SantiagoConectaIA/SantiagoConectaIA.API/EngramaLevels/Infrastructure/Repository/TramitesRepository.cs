...
namespace SantiagoConectaIA.API.EngramaLevels.Infrastructure.Repository
{
	public class TramitesRepository : ITramitesRepository
	{
		...
		{
			var res = await _managerHelper.GetAllAsync<spGetTramites.Result, spGetTramites.Request>(request, "","SCIA");
		...
		{
			var res = await _managerHelper.GetAllAsync<spSearchTramites.Result, spSearchTramites.Request>(request, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAsync<spSaveTramite.Result, spSaveTramite.Request>(request, "","SCIA");
		...
		{
			var res = await _managerHelper.GetAllAsync<spGetRequisitosPorTramite.Result, spGetRequisitosPorTramite.Request>(request, "","SCIA");
			if (res.Ok) return res.Data;
		...
		{
			var res = await _managerHelper.GetAsync<spSaveRequisito.Result, spSaveRequisito.Request>(request, "","SCIA");
			if (res.Ok && res.Data != null) return res.Data;
		...
		{
			var res = await _managerHelper.GetAsync<spSaveDocumento.Result, spSaveDocumento.Request>(request, "","SCIA");
			if (res.Ok && res.Data != null) return res.Data;
		...
		{
			var respuesta = await _managerHelper.GetAllAsync<spGetTramitesCard.Result, spGetTramitesCard.Request>(daoModel, "","SCIA");
			if (respuesta.Ok)
			{
		...
		{
			var respuesta = await _managerHelper.GetAllAsync<spGetPasosPorTramite.Result, spGetPasosPorTramite.Request>(daoModel, "","SCIA");
		...
		{
			var respuesta = await _managerHelper.GetAllAsync<spGetDocumentosPorTramite.Result, spGetDocumentosPorTramite.Request>(daoModel, "","SCIA");
			if (respuesta.Ok) return respuesta.Data;
