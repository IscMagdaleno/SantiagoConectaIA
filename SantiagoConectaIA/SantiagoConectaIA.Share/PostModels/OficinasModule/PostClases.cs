namespace SantiagoConectaIA.Share.PostModels.OficinasModule
{
	...
	public class PostSearchOficinas
	{
	...
	public class PostLinkOficinaTramite
	{
	...
	public class PostGetOficinasPorTramite
	{
		public int iIdTramite { get; set; }
		public string vchTexto { get; set; }
		public bool bIncluirContacto { get; set; } = false;
