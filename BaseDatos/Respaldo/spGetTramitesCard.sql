...
(
    @iIdTramite INT = 0, -- Fix: User had no default, but logic implies optional. Added = 0 to match logic inside.
    @bActivo BIT = 1
)
AS
/*
...
BEGIN
    ...
    (
        ...
        -- New English Properties
        vchNombreTramiteEn VARCHAR(200) DEFAULT(''),
        vchDescripcionTramiteEn VARCHAR(MAX) DEFAULT(''),
    ...
    BEGIN TRY
        ...
        WHERE 
            (T.iIdTramite = @iIdTramite OR @iIdTramite = 0) 
