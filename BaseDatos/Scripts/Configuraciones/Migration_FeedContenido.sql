/*
** Migration: Feed de Contenido Principal (Phase 1)
** Aggregates Trámites, Noticias, Eventos and InformacionLocal (Cápsulas)
** into paginated feed + search SPs under schema SCIA.
** Date: 2026-08-12
*/
